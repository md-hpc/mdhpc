...
#$ -M eth@bu.edu
#$ -M ajamias@bu.edu
#$ -o output/cell_list/ts-1_tsd-1e-15_n-1024_output.txt
#$ -e output/cell_list/ts-1_tsd-1e-15_n-1024_output_error.txt
...
build/cell_list input/random_particles-1024.pdb output/cell_list/ts-1_tsd-1e-15_n-1024_output.csv
build/cell_list input/random_particles-1024.pdb output/cell_list/ts-1_tsd-1e-15_n-1024_output.csv
