...
#$ -M eth@bu.edu
#$ -M ajamias@bu.edu
#$ -o output/cell_list/ts-1_tsd-1e-15_n-16384_output.txt
#$ -e output/cell_list/ts-1_tsd-1e-15_n-16384_output_error.txt
...
build/cell_list input/random_particles-16384.pdb output/cell_list/ts-1_tsd-1e-15_n-16384_output.csv
build/cell_list input/random_particles-16384.pdb output/cell_list/ts-1_tsd-1e-15_n-16384_output.csv
